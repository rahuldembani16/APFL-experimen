...
class GetDataSet(object):
    def __init__(self, dataSetName, isIID):
        ...
        elif self.name == 'plantvillage':
            self.load_plantvillage_data(isIID)
        else:
            pass
    ...
    def load_plantvillage_data(self, isIID):
        ...
        self.train_label = train_labels.numpy()
        self.test_data = test_data.numpy()
        self.test_label = test_labels.numpy()
        ...
        if isIID:
            ...
            order = np.argsort(self.train_label)
            self.train_data = self.train_data[order]
            self.train_label = self.train_label[order]
